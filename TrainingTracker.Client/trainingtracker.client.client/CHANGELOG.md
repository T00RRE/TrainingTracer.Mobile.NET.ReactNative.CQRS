...
- Utwórz projekt React z create-vite: `npm init --yes vite@latest trainingtracker.client.client -- --template=react`.
- Utwórz plik projektu (`trainingtracker.client.client.esproj`).
